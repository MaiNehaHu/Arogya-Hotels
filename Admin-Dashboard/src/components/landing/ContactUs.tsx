        ...
        <section className="bg-white py-32 px-4" id="contact">
            <div className="max-w-7xl mx-auto text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {/* WhatsApp Card */}
                    <div className="bg-green-100 p-6 py-10 rounded-xl shadow-sm hover:shadow-md transition">
                        ...
                        <p className="text-green-600 font-semibold">+91 12345 67890</p>
                    </div>

                    {/* Phone Card */}
                    <div className="bg-orange-100 p-6 py-10 rounded-xl shadow-sm hover:shadow-md transition">
                        <div className="flex justify-center mb-10">
                        ...
                        <p className="text-orange-500 font-semibold">+91 12345 67890</p>
                    </div>

                    {/* Email Card */}
                    <div className="bg-gray-100 p-6 py-10 rounded-xl shadow-sm hover:shadow-md transition">
                        <div className="flex justify-center mb-10">
                        ...
                        <p className="text-slate-800 font-semibold">info@homemeal.com</p>
                    </div>
                </div>
            </div>
        </section>
